...
[alt,temp,ind] = barom('barometro/data/l2/subida_1-2012_02_21_xx_22_01_45.log',1,0);
title('Subida 1')
hp=flipud(load('barometro/data/l2/README')); % alturas posta
hp1=hp+mean(alt(ind(1):ind(2)))-hp(1);
j=1;
for i=1:2:length(ind)
    line([ind(i) ind(i+1)],[hp1(j) hp1(j)],'color','red')
...
[alt,temp,ind] = barom('barometro/data/l2/subida_2-2012_02_21_xx_22_32_29.log',1,0);
title('Subida 2')
hp=flipud(load('barometro/data/l2/README')); % alturas posta
hp2=hp+mean(alt(ind(1):ind(2)))-hp(1);
j=1;
for i=1:2:length(ind)
    line([ind(i) ind(i+1)],[hp2(j) hp2(j)],'color','red')
...
[alt,temp,ind] = barom('barometro/data/l2/bajada_1-2012_02_21_xx_22_19_33.log',1,0);
title('Bajada 2')
hp=(load('barometro/data/l2/README')); % alturas posta
hp3=hp+mean(alt(ind(1):ind(2)))-hp(1);
j=1;
for i=1:2:length(ind)
    line([ind(i) ind(i+1)],[hp3(j) hp3(j)],'color','red')
