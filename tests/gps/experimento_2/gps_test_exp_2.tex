...
\\
  \subfloat[Caminata \#3]{\label{fig:caminata3.png}
  		\includegraphics[width=0.55\textwidth]{./img/caminata3.png}}
...
\begin{itemize}
\item Bajo las condiciones anteriores, se concluye que es razonable asumir que las medidas del GPS tienen un error de 2.5m, y que promedios de 2 minutos son suficientes (y más no es necesario).
\item El GPS es adecuando para navegación en un sentido más global. No parece ser adecuando para tareas de navegación local, del orden del metro, pero sí para distancias del orden de la decena de metros. En la figura \ref se observa (ver línea delgada) el log del recorrido con el GPS, que consistió en recorrer Julio María Sosa, sobre el cordón de un lado, y regresar por el lado opuesto, también cerca del cordón.
\end{itemize}

\begin{figure}[h!]
\centering
  \includegraphics[width=.8\textwidth]{./img/calle.png}
  \caption{Caminatas extensa}
  \label{fig:calle.png}
\end{figure}
...
\begin{enumerate}
\item El GPS no entrega datos \textbf{nuevos} a 1Hz, y el software refleja esto manteniendo el datos constante.
