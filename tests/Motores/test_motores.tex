...
\subsubsection*{Modelos de ajuste}
Al igual que en el experimento anterior se fuerzan los modelos para que pasen por el cero ya que sin comando $I^2C$ no hay velocidad angular y por lo tanto no hay torque. Realizando esta consideración y los modelos estudiados phara las fuerzas y momentos de las hélices se proponen los siguientes modelos de ajuste:
