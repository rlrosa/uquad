...
Esta reducción confirma que el valor descartado es un \emph{outlier}, ya que al no tener que ajustar los parámetros considerando dicho valor el error total se reduce considerablemente. Es interesante realizar nuevamente dicha medida. (¿Vale la pena hacerlo?)
 %TODO. 
