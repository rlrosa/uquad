...
\begin{huge}
\emph{\textbf{En \highlight{este haighlaitiado} pongo las cosas que me parecen mal, o q hay q cambiar y en \highlightdos{este otro} pongo lo q me parece que debería ir}}
\end{huge}
...
Los ángulos del mismo son prácticamente rectos difiriendo a lo sumo en \highlight{un} $\rightarrow$ \highlightdos{medio} grado. \\

Se construyo una plataforma \highlightdos{de madera} en forma de mesa con la tapa superior móvil, de modo que permite el giro sobre uno de sus lados, como se muestra en la figura \ref{fig:mesa} \highlight{que puede girar sobre un eje}. A su vez, es posible ajustar el dispositivo de forma de asegurar que dicho eje se encuentre en posición horizontal, \highlightdos{por medio de 3 patas de altura regulable}. Para realizar las 15 medidas se irá modificando el ángulo de la \highlightdos{tapa movil de la} plataforma. \highlightdos{En cada posición de la plataforma se tomarán medidas en 3 posiciones distintas del cubo.} El ángulo con la horizontal de la tapa superior puede calcularse como:
\begin{equation}
\arcsin \left( \frac{b-a}{c} \right)
\end{equation} 
Donde las distancias son las indicadas en la figura \ref{fig:mesa-flotando}.
...
\begin{huge}
\emph{\textbf{\highlight{Hay que cambiar esta gráfica}\\
\indent\highlight {Los ejes estan mal}}}
\end{huge}
...
\hline 
\multicolumn{1}{|p{30pt}|}{\cellcolor[gray]{0.6} \textbf{Distancias (cm)}} & \multicolumn{1}{|p{30pt}|}{\cellcolor[gray]{0.6} \textbf{Ángulo(°)}} &\multicolumn{1}{|p{30pt}|}{\cellcolor[gray]{0.6} \textbf{a medida}}  &
...
Una vez obtenidos estos parámetros se grafican en la imagen \ref{fig:convertidas} las medidas de aceleración obtenidas para algunos casos. Por simpleza en el análisis se toman los tres casos en los cuales $\alpha = 0$. Puede verse que las aceleraciones medidas se corresponden en muy buena forma con las aceleraciones teóricas, sin embargo las mismas poseen un error. Este error medido en la aceleración se integrará dos veces a la hora de obtener la posición produciendo una deriva en la posición. Es importante caracterizar esta deriva, ya que nos permite saber durante cuanto tiempo podemos utilizar la medida del acelerómetro sin necesidad de integrarla con la de otro sensor (por ejemplo un GPS). Dichos errores pueden verse representados gráficamente en la figura \ref{fig:errores}

\begin{figure}[H] %{l}{1.11\textwidth}
  \vspace{-20pt}
  \begin{center}
    \subfloat[Orientación y] {\includegraphics[width=0.37\textwidth]{./Pics/y.jpg}}
    \subfloat[Orientación z] {\includegraphics[width=0.37\textwidth]{./Pics/z.jpg}}
    \subfloat[Orientación -x] {\includegraphics[width=0.37\textwidth]{./Pics/-x.jpg}}    
  \end{center}
  \vspace{-20pt}
  \caption{Medidas de aceleración en el sistema de la plataforma. Caso $\alpha = 0$}
  \label{fig:convertidas}
  \vspace{-10pt}
\end{figure}
...
\begin{figure}[H] %{l}{1.11\textwidth}
  \vspace{-20pt}
  \begin{center}
    \subfloat[Errores en las direcciones x,  z] {\includegraphics[width=0.37\textwidth]{./Pics/errory.jpg}}
    \subfloat[Errores en las direcciones x,  y] {\includegraphics[width=0.37\textwidth]{./Pics/errorz.jpg}}
    \subfloat[Errores en las direcciones y,  z] {\includegraphics[width=0.37\textwidth]{./Pics/error-x.jpg}}    
  \end{center}
  \vspace{-20pt}
  \caption{Errores en la posición en los ejes en los cuales no hay aceleración Caso $\alpha = 0$}
  \label{fig:errores}
  \vspace{-10pt}
\end{figure}


De los resultados gráficos obtenidos parece razonable pensar que se puede trabajar con el acelerómetro sin corrección del GPS durante 10 segundos aproximadamente, ya que en estas condiciones el error en la posición es inferior a los 2 metros.  
\end{document}