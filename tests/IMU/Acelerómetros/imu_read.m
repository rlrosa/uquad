...
% offset  = 2^10/2;           % ADC de 10 bits
% acc_fs  = 6;                % Acc full scale
% acc_sens = acc_fs/511;      % Cantidad de 'g' que representa 1 bit
% gyro_fs = 300;              % Gyro full scale
% gyro_sens = gyro_fs/511;    % Cantidad de °/s que representa 1 bit
...
%     w(i,3) = ( str2num(D{1}{9*(i-1)+8}) - offset ) * gyro_sens;   
    ...
    a(i,1) = str2num(D{1}{9*(i-1)+3});
    a(i,2) = str2num(D{1}{9*(i-1)+4});
