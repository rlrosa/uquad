...
x0_lin=[.1 .1];
[alpha,RESNORM_lin,RESIDUAL_lin,EXITFLAG_lin]=lsqnonlin(@temp_acc_cost_2,x0_lin,[],[],optimset('MaxFunEvals',10000));
...
for i=1:length(a(:,1))
    aux = (K*(1+alpha(1)*(t_imu(i)-to)))^-1 * (a(i,:)'-b*(1+alpha(2)*(t_imu(i)-to)));
