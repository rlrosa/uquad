/**
 * imu_comm_test: test program for imu library.
 ...
 *
 * @file   imu_comm_test.c
 * @author Rodrigo Rosa <rodrigorosa.lg gmail.com>, Matias Tailanian <matias tailanian.com>, Santiago Paternain <spaternain gmail.com>
 * @date   Sun May 27 10:02:32 2012
 *
 * @brief  test program for imu library.
 *
 */
#include <imu_comm.h>
...
#if PRINT_RAW
    // Setup raw frame log
    log_imu_raw = uquad_logger_add("imu_raw","./", 0);
    if(log_imu_raw == NULL)
    {
...
#if PRINT_DATA
    // Setup data log
    log_imu_data = uquad_logger_add("imu_data","./", 0);
...
#if PRINT_AVG
    // Setup avg log
    log_imu_avg = uquad_logger_add("imu_avg","./", 0);
    if(log_imu_avg == NULL)
    {
