...
ctrl_t *control_init(void)
{
    ...
    // GOOD MATRIX ?
    ctrl -> K -> m[0][0] = 0.49934047680803017588;
    ctrl -> K -> m[0][1] = 0.00000000000017122169;
    ctrl -> K -> m[0][2] = -21.75937550244206519778;
    ctrl -> K -> m[0][3] = -15.62508835442807964000;
    ctrl -> K -> m[0][4] = 3.85038861888411654277;
    ctrl -> K -> m[0][5] = 0.00000000000001624196;
    ctrl -> K -> m[0][6] = -8.15001366200120891392;
    ctrl -> K -> m[0][7] = -13.27952808741211931931;
    ctrl -> K -> m[1][0] = 0.49934047680804971581;
    ctrl -> K -> m[1][1] = 21.75937550244172768998;
    ctrl -> K -> m[1][2] = -0.00000000000003756029;
    ctrl -> K -> m[1][3] = 15.62508835442773680313;
    ctrl -> K -> m[1][4] = 3.85038861888415251400;
    ctrl -> K -> m[1][5] = 8.15001366200113785965;
    ctrl -> K -> m[1][6] = 0.00000000000001882213;
    ctrl -> K -> m[1][7] = 13.27952808741187418207;
    ctrl -> K -> m[2][0] = 0.49934047680801718627;
    ctrl -> K -> m[2][1] = -0.00000000000008256758;
    ctrl -> K -> m[2][2] = 21.75937550244189822024;
    ctrl -> K -> m[2][3] = -15.62508835442801213844;
    ctrl -> K -> m[2][4] = 3.85038861888394690070;
    ctrl -> K -> m[2][5] = 0.00000000000000081247;
    ctrl -> K -> m[2][6] = 8.15001366200113785965;
    ctrl -> K -> m[2][7] = -13.27952808741166634832;
    ctrl -> K -> m[3][0] = 0.49934047680805709879;
    ctrl -> K -> m[3][1] = -21.75937550244187335124;
    ctrl -> K -> m[3][2] = 0.00000000000007485393;
    ctrl -> K -> m[3][3] = 15.62508835442848997843;
    ctrl -> K -> m[3][4] = 3.85038861888423955548;
    ctrl -> K -> m[3][5] = -8.15001366200116628136;
    ctrl -> K -> m[3][6] = 0.00000000000003355322;
    ctrl -> K -> m[3][7] = 13.27952808741203050147;
