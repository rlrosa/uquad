...
El lazo cerrado simula las acciones de control del sistema. Adem\'as de las ecuaciones del lazo abierto (ecuaci\'on \ref{eq:lazo_abierto}) se agrega la realimentaci\'on de las variables de estado ($x,y,z,\psi,\varphi,\theta,v_{qx},v_{qy},v_{qz},\omega_{qx},\omega_{qy},\omega_{qz}$) y de las integrales de $x,y,z,\theta$. Llamamos $X_I$ al vector compuesto por dichas integrales. La ecuaci\'on de realimentaci\'on es:
