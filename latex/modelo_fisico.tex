...
Finalmente debemos considerar el radio promedio de la Tierra($R_T=$), ya que las alturas que alcanzará nuestro sistema son despreciables respecto del radio de la Tierra. 
%TODO Radio de la Tierra y terminar
...
&\dot{v_{q_z\prime}}=v_{q_y\prime} \omega_{q_z\prime} - v_{q_z\prime} \omega_{q_y\prime}+Mg\sin\varphi\\
&\dot{v_{q_y\prime}}=v_{q_z\prime} \omega_{q_x\prime} - v_{q_z\prime} \omega_{q_z\prime}-Mg\cos\varphi\sin\psi\\
&\dot{v_{q_z\prime}}=v_{q_z\prime} \omega_{q_y\prime} - v_{q_y\prime} \omega_{q_x\prime}-Mg\cos\varphi\cos\psi+\sum_{i=1}^4T_i\\
