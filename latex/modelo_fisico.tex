...
Donde $d$ es la distancia entre el centro de masa del sistema y el centro de coordenadas del sistema solidario al cuadric\'optero y $\Pi_{O^\prime_q}^{\{\vec{i_q}, \vec{j_q}, \vec{k_q}\}}$ el tensor de inercia del cuadric\'optero sin considerar los motores.\\
...
Derivando esta expresi\'on y adicionandola al resultado obtenido en \ref{eq:dmomento} podemos escribir la derivada del momento angular del sistema como:
