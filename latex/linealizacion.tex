...
Las t\'ecnicas de control m\'as sencillas y con las que se tiene mayor experiencia se basan en el estudio de sistemas lineales invariantes en el tiempo (SLIT). El MVE obtenido en el cap\'itulo \ref{chap:modelo} es no lineal. Se propone entonces resolver el problema del control del cuadric\'optero aproximando el sistema por un sistema lineal invariante en el tiempo. En una primera instancia nos concentraremos en determinar bajo que condiciones es posible aproximar el sistema por un SLIT.
