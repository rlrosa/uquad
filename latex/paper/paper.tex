...
%\vspace{-.8cm}
	\centering
	\includegraphics[width=.8\columnwidth]{./pics_paper/diagrama_tio.png}
	\caption{\textbf{Complete system block diagram.}}
