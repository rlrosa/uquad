...
\vspace{-30pt}
  \begin{center}
    \includegraphics[width=.45\textwidth]{./pics_gps/dop.png}
  \end{center}
\vspace{-20pt}
...
Básicamente, el DOP representa la sensibilidad de localización frente a errores en las medidas. Dicho de otro modo, da una idea de qué tanto error se cometerá en la ubicación ante errores en las medidas. Cuanto más bajo sea el DOP, se cometerá un error menor. En la tabla \ref{tab:dop} se muestra como interpretar valores típicos (información tomada de \cite{bib:sat-dop-values}).
