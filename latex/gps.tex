...
\begin{figure}[h!]
\vspace{-20pt}
  \subfloat[Orientación: \textbf{1} (Misma que 4)]{\label{fig:2m_or1_todos.png}
    \includegraphics[width=.5\textwidth]{./pics_gps/2m_or1_todos.png}}
  \subfloat[Orientación: \textbf{2}.]{\label{fig:2m_or2_todos.png}
    \includegraphics[width=.5\textwidth]{./pics_gps/2m_or2_todos.png}}\\

  \subfloat[Orientación: \textbf{3}.]{\label{fig:or2_todos_cut.png}
    \includegraphics[width=.5\textwidth]{./pics_gps/or2_todos_cut.png}}
  \subfloat[Orientación: \textbf{4}]{\label{fig:or3_todos.png}
    \includegraphics[width=.5\textwidth]{./pics_gps/or3_todos.png}}
...
\vspace{-30pt}
  \begin{center}
  \includegraphics[width=.6\textwidth]{./pics_gps/altura_punto_fijo_fing.png}
  \end{center}
\vspace{-25pt}
  \caption{Medida de la altura a distintas\newline alturas.}
...
\item \textbf{Error y velocidad:} Cabe destacar que se observ\'o una mejora en la performance del GPS cuando el sistema se mueve a velocidades mayores a $1m/s$, pero por una cuesti\'on de tiempo no se hicieron pruebas para estudiar este comportamiento.
