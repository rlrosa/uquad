...
\begin{figure} [h!]
  ...
  \subfloat[Trípode de fotografía, con el GPS atado en lugar de la cámara..]{\label{fig:tripode_con_plomada.jpg}
    \includegraphics[width=0.35\textwidth]{./pics_gps/tripode_con_plomada.jpg}}
  \subfloat[GPS amarrado al trípode.]{\label{fig:vista_usb.jpg}
    \includegraphics[width=0.35\textwidth]{./pics_gps/vista_usb.jpg}}
  \caption{GPS + Atril}
  \label{fig:rebotes}
  \vspace{-50pt}
\end{figure}
...
\centering
\subfloat[Diagonales del polígono en cm. Lectura: \textbf{D24} representa la longitud (en cm) de la recta que une el punto $2$ con el punto $4$.]{\label{tab:diagonales-poligono}
...
\hline
\end{tabular}}\\
\subfloat[Polígono luego de MC.]{\label{fig:pol_mc.png}
...
\begin{figure} [h!]
  ...
  \subfloat[Caminata \#1]{\label{fig:caminata1.png}
    \includegraphics[width=0.45\textwidth]{./pics_gps/caminata1.png}}
  \subfloat[Caminata \#2]{\label{fig:caminata2.png}
    \includegraphics[width=0.45\textwidth]{./pics_gps/caminata2.png}}
  \label{fig:caminatas}
\end{figure}
