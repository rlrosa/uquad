...
% affiliations
\author{\IEEEauthorblockN{Mat\'ias Tailani\'an}
\IEEEauthorblockA{Universidad de la Rep\'ublica\\
Montevideo, Uruguay\\
matias@tailanian.com}
\and
\IEEEauthorblockN{Santiago Paternain}
\IEEEauthorblockA{Universidad de la Rep\'ublica\\
Montevideo, Uruguay\\
...
\begin{figure}
  ...
  \subfloat[\textbf{General diagram}]{\label{fig:diagrama_kalman1} 
	\includegraphics[width=.65\columnwidth] {./pics_paper/diagrama_kalman_eng.png}} 
  \subfloat[\textbf{Double EKF -} Detail.]{\label{fig:double_ekf} 
	\includegraphics[width=0.28\columnwidth] {./pics_paper/double_ekf.png}}
...
%   \]
 ...
 %Furthermore the GPS measurements can be also used as filter input. All this primary estimations from sensors are considered as measurements in the Kalman Filter, while the prediction is based, as said, in the dynamic model.
...
\begin{figure}
  \centering
  \subfloat[Without bias estimation]{\label{fig:sin_bias} \includegraphics[width=0.4\columnwidth] {./pics_paper/sin_bias.pdf}} \hspace*{-5pt}
  \subfloat[With bias estimation]{\label{fig:con_bias} \includegraphics[width=0.4\columnwidth] {./pics_paper/con_bias.pdf}}
