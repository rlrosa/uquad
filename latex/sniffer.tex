...
Como se dijo anteriormente, para realizar el proceso de ingenier\'ia inversa se utiliz\'o el cuadric\'optero y un analizador l\'ogico. La forma de operar es enviar comandos conocidos con el control remoto y analizar el flujo de datos en las l\'ineas del bus. En la figura \ref{fig:sniffing} se muestra una foto del proceso descripto.
