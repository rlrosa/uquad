...
\item \textbf{\'Angulos de Euler:} Para calcular los \'angulos de Euler (en radianes) a partir del vector de aceleraci\'on y del campo magn\'etico se tom\'o como referencia \cite{bib:euler_magneto_acc}. Se utilizan las siguientes ecuaciones:
  ...
  \hspace{-20pt}
  M = 
  \left(\begin{array}{ccc} \frac{\cos\!\left(\mathrm{\phi}\right)}{{\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2} & \frac{\sin\!\left(\mathrm{\phi}\right)\, \sin\!\left(\mathrm{\psi}\right)}{\left({\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2\right)\, \left({\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2\right)} & \frac{\cos\!\left(\mathrm{\psi}\right)\, \sin\!\left(\mathrm{\phi}\right)}{\left({\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2\right)\, \left({\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2\right)}\\ 0 & \frac{\cos\!\left(\mathrm{\psi}\right)}{{\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2} & -\frac{\sin\!\left(\mathrm{\psi}\right)}{{\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2}\\ -\frac{\sin\!\left(\mathrm{\phi}\right)}{{\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2} & \frac{\cos\!\left(\mathrm{\phi}\right)\, \sin\!\left(\mathrm{\psi}\right)}{\left({\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2\right)\, \left({\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2\right)} & \frac{\cos\!\left(\mathrm{\phi}\right)\, \cos\!\left(\mathrm{\psi}\right)}{\left({\cos\!\left(\mathrm{\phi}\right)}^2 + {\sin\!\left(\mathrm{\phi}\right)}^2\right)\, \left({\cos\!\left(\mathrm{\psi}\right)}^2 + {\sin\!\left(\mathrm{\psi}\right)}^2\right)} \end{array}\right)
  \]
