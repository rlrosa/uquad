...
\centering
\vspace{-40pt}
  \subfloat[Vista general]{\label{fig:protec_gral}
  		\includegraphics[width=.55\textwidth]{./pics_montaje/proteccion_completo.png}}
  \subfloat[Detalle de motor]{\label{fig:protec_mot} 
  		\includegraphics[width=.25\textwidth]{./pics_montaje/proteccionmotor.png}}
  \caption{Protección}
