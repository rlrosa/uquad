...
\item La velocidad angular del sistema
\end{itemize}
...
\\
A partir de las consideraciones anteriores, se considera que la solución más adecuada para el objetivo que se plantea en esta sección es la placa \emph{Razor Atomic IMU}.\\
...
En la figura \ref{fig:IMU} se puede observar la placa de instrumentación escogida:
