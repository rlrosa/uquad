...
Para la detección del marcador se utilizará como base la detección de segmentos con el algoritmo \textbf{LSD}\footnote{ \url{http://www.ipol.im/pub/algo/gjmr_line_segment_detector/}}.\\
