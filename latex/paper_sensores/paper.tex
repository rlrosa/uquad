...
Due to construction issues the sensibility axis of the device are generaly not orthogonals. Let $\mathbf{a}^a$ be the acceleration measured by the accelerometer and let $\mathbf{a}^p$.
