...
The calibration proposed in this paper is tested on an accelerometer ADXL345 of Analog Devices and a gyroscope ITG-3200  of InvenSense, yet the model developed and the methodology can be used in other devices because the model is based on comun characteristics of MEMS sensors.\\
