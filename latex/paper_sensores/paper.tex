...
\begin{figure}[h!]
	\subfloat[Accelerometer measurement in\newline z-axis vs. temperature while heating\newline up the sensor.]{\label{fig:resultado_temp} 
			\includegraphics[width=.5\columnwidth]{./pics_paper/resultado_temp.png}}
	\subfloat[Accelerometer measurements and temperature (T) vs. time while T varying from $35^oC$ to $48^oC$.]{\label{fig:bajada}
		\includegraphics[width=.5\columnwidth]{./pics_paper/bajada.png}}
