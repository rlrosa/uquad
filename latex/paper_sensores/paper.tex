...
Due to construction issues the sensibility axis of the device are generaly not orthogonals. Lets define a platform system as shown in figure \ref{fig:mongoose}Let $\mathbf{a}^a$ be the acceleration measured by the accelerometer and let $\mathbf{a}^p$ the acceleration measured in the platform system. We model this fact by the following linear transformation between the two acceleration vectors:
