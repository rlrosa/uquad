...
On the other hand, the typical offset error is $\pm 40 ^\circ s^{-1}$
\subsection{Temperature adjust}
...
\begin{figure}[h!]
	\subfloat[Accelerometer measurement in\newline z-axis while heating up the sensor.]{\label{fig:resultado_temp} 
			\includegraphics[width=.5\columnwidth]{./pics_paper/resultado_temp.pdf}}
	\subfloat[Accelerometer measurements and temperature varying from $35^oC$ to $48^oC$.]{\label{fig:bajada}
		\includegraphics[width=.5\columnwidth]{./pics_paper/bajada.pdf}}
