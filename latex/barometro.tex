...
% \begin{figure}[h!]
%   \includegraphics[width=1\textwidth]{./pics_barom/1hora_02.pdf}
...
\hspace{-70pt}
  ...
  \includegraphics[width=.65\textwidth]{./pics_barom/esc1.pdf}}
	\subfloat[Segunda serie de medidas cada 1 metro.]{\label{fig:esc2.pdf}
  \includegraphics[width=.65\textwidth]{./pics_barom/esc2.pdf}}
\vspace{-10pt}
...
\hspace{-50pt}
	...
	\subfloat[Error en la estimación de la distancia del piso anterior al actual.]
...
\hspace{-50pt}
	\subfloat[Error acumulado.]
        {\label{fig:cm-err-accum.pdf}
	\includegraphics[width=.6\textwidth]
        {./pics_barom/cm-err-accum.pdf}}
	\subfloat[Error en la estimación de la distancia del estante anterior al actual.]
        {\label{fig:cm-err-punto-a-punto.pdf}
	\includegraphics[width=0.6\textwidth]
        {./pics_barom/cm-err-punto-a-punto.pdf}}
