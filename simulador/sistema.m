...
F =[x(3)*cos(x(2))+x(4)*sin(x(1))*sin(x(2))+x(5)*cos(x(1))*cos(x(2));
    x(4)*cos(x(1))-x(5)*sin(x(1))*sin(x(2))-V;
    -x(3)*sin(x(2))+x(4)*cos(x(2))*sin(x(1))+x(5)*cos(x(1))*cos(x(2));
...
%x(3) - 2*V*sin(x(2))*cos(x(2))*sin(x(1))/(cos(x(1))*(sin(x(2))^2-cos(x(1))*cos(x(2))));
    %x(4) - V*cos(x(2))/(sin(x(2))^2-cos(x(1))*cos(x(2)));
    %x(5) - V*sin(x(2))/(sin(x(2))^2-cos(x(1))*cos(x(2)));
