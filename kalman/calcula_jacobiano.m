...
syms x y z ax ay az vqx vqy vqz wqx wqy wqz psi phi theta T TM1 TM2 TM3 TM4 w1 w2 w3 w4 dw1 dw2 dw3 dw4 D1 D2 D3 D4 g M Ixx Iyy Izz Izzm L dvqx dvqy dvqz 

f = @(x,y,z,psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz,w1,w2,w3,w4,dw1,dw2,dw3,dw4,TM1,TM2,TM3,TM4,D1,D2,D3,D4) [ ...    
...
F=jacobian(f(x,y,z,psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz,w1,w2,w3,w4,dw1,dw2,dw3,dw4,TM1,TM2,TM3,TM4,D1,D2,D3,D4),[x,y,z,psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz])

h = @(psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz,z,TM1,TM2,TM3,TM4) [ ... 
    psi ; 
    phi ; 
    theta ; 
    0;
...
H=jacobian(h(psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz,z,TM1,TM2,TM3,TM4),[x,y,z,psi,phi,theta,vqx,vqy,vqz,wqx,wqy,wqz])
