...
\centering
  \subfloat[Tanda normal de ceros]{\label{fig:snif_arranque_ceros}
  		\includegraphics[width=1\textwidth]{./pics/snif_arranque_ceros.png}} \\
  \subfloat[Última tanda de ceros]{\label{fig:snif_arranque_ultimos_ceros} 
  		\includegraphics[width=1\textwidth]{./pics/snif_arranque_ultimos_ceros.png}}
...
\centering
  \subfloat[Valores enviados a los motores]{\label{fig:arranque_val}
  		\includegraphics[width=.5\textwidth]{./pics/arranque_val.png}}
  \subfloat[Registro al que se envía el valor]{\label{fig:arranque_reg} 
  		\includegraphics[width=.5\textwidth]{./pics/arranque_reg.png}}
  \caption{Arranque}
  \label{fig:arranque}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\textwidth]{./pics/snif_frenado.png}
	\caption{Frenado}
...
\centering
  \subfloat[Valores enviados a los motores]{\label{fig:frenado_val}
  		\includegraphics[width=.5\textwidth]{./pics/frenado_val.png}}
  \subfloat[Registro al que se envía el valor]{\label{fig:frenado_reg} 
  		\includegraphics[width=.5\textwidth]{./pics/frenado_reg.png}}
  \caption{Frenado}
  \label{fig:frenado}
\end{figure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\begin{center}
	\includegraphics[width=0.4\textwidth]{./pics/MSP430F5438.jpg}
	\end{center}
	\vspace{-20pt}
	\caption{MSP430F5438}
...
\centering
  \subfloat[Valores enviados a los motores]{\label{fig:MSP_arranque_val}
  		\includegraphics[width=.5\textwidth]{./pics/MSP_arranque_val.png}}
  \subfloat[Registro al que se envía el valor]{\label{fig:MSP_arranque_reg} 
  		\includegraphics[width=.5\textwidth]{./pics/MSP_arranque_reg.png}}
...
\centering
  \subfloat[Valores enviados a los motores]{\label{fig:MSP_frenado_val}
  		\includegraphics[width=.5\textwidth]{./pics/MSP_frenado_val.png}}
  \subfloat[Registro al que se envía el valor]{\label{fig:MSP_frenado_reg} 
  		\includegraphics[width=.5\textwidth]{./pics/MSP_frenado_reg.png}}
  \caption{Frenado}
