...
text(t(ceil(0.5*length(t))),0.93*(Xmax-Xmin)+Xmin,'\fontsize{12}90% del valor en régimen')
plot(t(1:end),(0.1*(Xmax-Xmin)+Xmin)*ones(length(X),1),'r--')
text(t(ceil(0.5*length(t))),0.13*(Xmax-Xmin)+Xmin,'\fontsize{12}10% del valor en régimen')
